...
package com.box.me.widget.helper;
...
public class ScrollHelper extends RecyclerView.OnScrollListener {
    ...
    public ScrollHelper(@NonNull RecyclerView recyclerView) {
        this(recyclerView, null);
    }

    public ScrollHelper(@NonNull RecyclerView recyclerView, @Nullable AppBarLayout appBarLayout) {
